...
public abstract class ReadCommand extends AbstractReadQuery
{
    ...
    public Index getIndex(ColumnFamilyStore cfs) {
        return null!=indexQueryPlan ? 
            cfs.indexManager.getIndex(indexQueryPlan.getIndexMetadata()) 
            : null;
   ...
   static Index.QueryPlan findIndexQueryPlan(TableMetadata table, RowFilter rowFilter, DataRange dataRange)
    {
    ...
    static Index.QueryPlan findIndexQueryPlan(TableMetadata table, RowFilter rowFilter, DecoratedKey partitionKey)
    {
        if (table.indexes.isEmpty() || rowFilter.isEmpty())
            return null;
