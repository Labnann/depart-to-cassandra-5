...
public abstract class AbstractAllocatorMemtable extends AbstractMemtableWithCommitlog
{
    ...
    private static void scheduleFlush(Owner owner, int periodIn)
    {
    ...
    private void flushIfPeriodExpired()
    {
        ...
        {
           // FIXME: logger.debug("----flushing memtable, size: {}", current.getLiveDataSize());
    ...
    public static Future<Boolean> flushLargestMemtable()
    {
        ...
        {
            StorageService.instance.largestCFS = largestMemtable.cfs;
